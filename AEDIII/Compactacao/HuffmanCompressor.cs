...
namespace AEDIII.Compactacao
{
    ...
    public class HuffmanCompressor : ICompressor
    {
        ...
        {
            // 1. Lê o arquivo inteiro como um array de bytes
            //    - "data" agora contém todos os bytes (binários) do arquivo original.
            byte[] data = File.ReadAllBytes(inputPath);

            // 2. Conta a frequência de cada byte
            //    - Usamos um dicionário para mapear cada byte (0–255) à quantidade de vezes que aparece.
